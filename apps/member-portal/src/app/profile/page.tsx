...
export default function MemberProfilePage() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in p-6 md:p-10 max-w-7xl mx-auto pb-24 print:p-0">
      ...
      {/* ========================================================================= */}
      <div className="hidden print:flex absolute top-0 left-0 w-full min-h-[297mm] bg-white z-[9999] text-slate-800" id="cv-print">
        
        {/* CỘT TRÁI (NỀN ĐẬM NKBA) - CHIẾM 1/3 */}
        {/* ĐÃ SỬA: Chỉnh padding p-10 thành px-8 pt-6 pb-10 để đẩy lên */}
        <div className="w-1/3 bg-[#002D62] text-white px-8 pt-6 pb-10 flex flex-col min-h-full">
          
          {/* AVATAR */}
          {/* ĐÃ SỬA: Xóa margin-top mt-4, chỉnh mb-10 thành mb-8 */}
          ...
          {/* THÔNG TIN LIÊN HỆ */}
          <div className="mb-8 space-y-4 text-sm font-medium text-blue-100">
          ...
          {form.education.length > 0 && (
            <div className="mb-8">
              <h3 className="text-white font-black tracking-widest uppercase border-b border-white/20 pb-2 mb-4">Học vấn</h3>
          ...
          {form.skills && (
            <div className="mb-8">
              <h3 className="text-white font-black tracking-widest uppercase border-b border-white/20 pb-2 mb-4">Kỹ năng</h3>
          ...
          {form.languages.length > 0 && (
            <div>
              <h3 className="text-white font-black tracking-widest uppercase border-b border-white/20 pb-2 mb-4">Ngoại ngữ</h3>
        ...
        {/* ĐÃ SỬA: Đổi padding p-12 thành px-10 pt-8 pb-12 để đẩy sát lên */}
        <div className="w-2/3 bg-white px-10 pt-8 pb-12 flex flex-col">
          
          {/* HEADER TÊN & CHỨC DANH */}
          {/* ĐÃ SỬA: Xóa mt-4 và giảm mb-12 xuống mb-10 */}
          ...
          {form.bio && (
            <div className="mb-8">
              <h3 className="text-lg font-black text-[#002D62] uppercase tracking-widest border-b-2 border-slate-100 pb-2 mb-3 flex items-center gap-2">
          ...
          {form.experiences.length > 0 && (
            <div className="mb-8">
              <h3 className="text-lg font-black text-[#002D62] uppercase tracking-widest border-b-2 border-slate-100 pb-2 mb-5 flex items-center gap-2">
